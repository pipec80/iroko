...
health alone is not acceptance. Since #208 was deployed the scan completes
(observed 2026-09-24, `failure_count` 0). That failing candidate is also real evidence of
