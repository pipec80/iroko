...
| MP-05 Firmas, duplicados, desorden y correlación cuenta/suscripción/factura/pago | [Webhooks][mp-webhooks], [API de suscripciones][mp-api]                                                                      | Implementado: firma/manifiesto, fetch remoto, resolución de referencia, IDs deterministas y reducer/RPC; CAS para snapshots.                                                                                                                                                                                                                                                                                                                                                | Provider/contract, webhook/reducer, SQL 11/36/37/38. Hay replay/idempotencia y CAS; no equivalen a toda permutación de eventos tardíos.                                                                                                                                                                                                                                  | Ciclo real 2026-09-10–17 (alias SUB-1/INV-1): 4 eventos (`invoice_paid`, `subscription_updated`, `subscription_canceled` y una re-confirmación de recovery el 17-09) correlacionan a la misma identidad en `events`/`subscriptions`/`invoices`/`payment_attempts`, sin fila duplicada ni cruce de cuenta.                                                                                                                        | Cerrado para el caso feliz con recuperación tardía sin duplicar. Firmas inválidas, replay adversarial y webhook concurrente con regresión de snapshot siguen sin ejercitar: **[NO VERIFICADO]**.                                                              |
...
| MP-11 Recovery de pago conocido                                                  | [Consulta de pago/factura][mp-api]                                                                                           | Implementado: job durable con payment ID; fetch del pago y búsqueda de authorized-payment por `payment_id`; backoff, lease, agotamiento y reducer compartido.                                                                                                                                                                                                                                                                                                               | Recovery/provider y SQL 37: correlación tardía, pending, error, lease, agotamiento y deduplicación.                                                                                                                                                                                                                                                                      | Job agendado (14, cada 5 min) en 1493/1493 `succeeded` entre 2026-09-17 y 2026-09-22, `last_summary.claimed=0` en todo el período. El 2026-09-17 sí re-confirmó manualmente el pago de INV-1 (alias) sin duplicar invoice ni payment_attempt — prueba idempotencia, no una reparación real: el pago ya estaba correctamente aplicado por el webhook original. Reparación de un pago realmente perdido sigue **[NO VERIFICADO]**. | Fase 6: ejecutar job contra un pago genuinamente ausente hasta resolución o escalamiento; repetir y probar concurrencia, sin doble aplicación.                                                                                                                |
