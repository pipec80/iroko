...
Last updated: **2026-09-24** (first real reconciliation-discovery scans, Cloud
lease drill and measured provider behaviors; provider acceptance remains
separate)
...
| -------------------------------- | --------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------- | -------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Documentation checker            | Documentation refresh branch                        | `pnpm docs:check`: 89 Markdown files passed; `pnpm test:docs-check`: 4/4; `pnpm exec prettier --ignore-path .prettierignore-docs --check` passed on the 9 Markdown files changed by the 2026-09-23 refresh (the full-tree run of 2026-09-22 covered 79 tracked files); `git diff --check` passed.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | 2026-09-23           | Commit/worktree-bound            | CURRENT for this documentary surface only                                                                                                                                                             |
| Production smoke                 | Vercel production                                   | Nightly Monitoring [run 35972662288](https://github.com/pipec80/iroko/actions/runs/35972662288) (2026-09-24 07:59 UTC): the Production Smoke Tests job succeeded.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | 2026-09-24 07:59     | 48 hours                         | **CURRENT** until 2026-09-26 07:59 UTC                                                                                                                                                                |
| Email worker                     | Linked Supabase                                     | Same Nightly Monitoring run: the Email Worker Health job succeeded.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | 2026-09-24 07:59     | 48 hours                         | **CURRENT** until 2026-09-26 07:59 UTC                                                                                                                                                                |
| Database advisors                | CI local database rebuilt from migrations           | Same Nightly Monitoring run: the Database Advisors job succeeded.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | 2026-09-24 07:59     | 48 hours                         | **CURRENT** until 2026-09-26 07:59 UTC                                                                                                                                                                |
...
| Mercado Pago basic circuit       | Test-seller sandbox via production deployment       | 2026-09-22 read-only database review confirmed the 2026-09-10 circuit with real correlated data (checkout → active → first invoice paid CLP 19.990 → provider cancellation with paid-through access preserved). See MP-01/02/05/07 in the [MP-01–15 matrix](../exec-plans/active/011-mercadopago-v1-chile-acceptance.md). Not real-money production acceptance.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | 2026-09-22           | Change-bound                     | **CURRENT** for this closed circuit; a second charge/renewal cycle remains **[NO VERIFICADO]**                                                                                                        |
| Mercado Pago v1 Chile acceptance | Monthly CLP, hosted pending/no associated plan      | [MP-01–15 matrix](../exec-plans/active/011-mercadopago-v1-chile-acceptance.md): MP-01/02/05/06 (rejection+alert)/07 (both directions)/11/15 closed with real correlated evidence, including a genuine recovery gap repair and a real triple webhook delivery handled without duplication. A rejected checkout that resumed a provider-invalidated preapproval later self-healed via reconciliation, confirming the manual resolver correctly refuses that case by design (MP-08's strict scenario, with a real needs_review row, remains open). Renewal is being observed on a live subscription due 2026-10-22; recovery-after-rejection and refunds remain open — a refund attempted on 2026-09-23 was rejected by the API (`Unauthorized use of live credentials`) and the operation is not shown in the test seller's panel, so MP-09/10 stay open until a productive account exists (provider limitation, not an Iroko defect). MP-04 and MP-14 are partial (see the [2026-09-23 drills](#mercado-pago-sandbox-drills-2026-09-23)). | 2026-09-23           | Scenario + change-bound          | Partially closed; **[NO VERIFICADO]** for the remaining scenarios                                                                                                                                     |
| Billing workers                  | Supabase scheduler/Vault → Vercel Node              | `cron.job_run_details`, last 48 h to 2026-09-24 14:09 UTC: job 14 (`billing-recovery-worker`, every 5 min) 576/576 `succeeded` (2026-09-22 14:10 → 2026-09-24 14:05 UTC); job 15 (`billing-reconciliation-worker`, hourly) 48/48 `succeeded` (2026-09-22 15:00 → 2026-09-24 14:00 UTC). Earlier window: recovery 1493/1493 (2026-09-17 → 2026-09-22). HTTP 200 does not mean candidate success: see the reconciliation discovery row.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | 2026-09-24 14:09 UTC | 48 hours + configuration changes | **CURRENT** for sustained invocation; volume and interruption drills remain **[NO VERIFICADO]**                                                                                                       |
| Reconciliation discovery         | Supabase scheduler → Vercel Node, live subscription | The first real discovery scans (2026-09-22/23) failed hourly: first `provider_fetch_failed` (Mercado Pago rejects `limit` above 15; fixed in #205), then `reducer_failed` (discovered invoices carried the checkout id as account; fixed in #208). After #208 was deployed the scan **completes**: on 2026-09-24 14:09 UTC `last_completed_at` is 13:00 UTC, `failure_count` 0, no error code, `invoice_watermark` advanced; 12 Mercado Pago events, 3 invoices, 0 anomalies and 0 open recovery jobs were unchanged from 00:51 to 14:09 UTC, so hourly replays add nothing. A genuinely omitted invoice has not occurred.                                                                                                                                                                                                                                                                                                                                                                                                               | 2026-09-24 14:09 UTC | Change-bound                     | **CURRENT** for scan completion and replay stability; the omitted-invoice scenario (MP-12) stays **[NO VERIFICADO]** ([Plan 011 matrix](../exec-plans/active/011-mercadopago-v1-chile-acceptance.md)) |
...
## Mercado Pago sandbox drills (2026-09-23)

Sanitized record of read-only checks and authorized sandbox drills against the
test seller and the linked Supabase project. No real-money operation took place;
no tokens, emails, checkout URLs or raw provider IDs are recorded.

| Drill                              | Observation                                                                                                                                                                                                                                                                                                                                                                               | Limit                                                                                                               |
| ---------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------- |
| Provider behaviors                 | Measured `limit` cap (15), `X-Idempotency-Key` ignored, `payer_email` required, `/preapproval/search` not filtering by `external_reference` and rate limiting. Three preapprovals were created `pending` for the idempotency probe and canceled immediately; Iroko received no events.                                                                                                    | Recorded in the [design](../architecture/mercadopago-reliability-design.md#verified-provider-behaviors-2026-09-23). |
| Refund attempt                     | `refunds create` on an approved sandbox payment answered `ERROR_UNAUTHORIZED: Unauthorized use of live credentials`; `refunds list` stayed empty; the seller panel shows no operation.                                                                                                                                                                                                    | MP-09/10 need a productive account. No money moved.                                                                 |
| Reconciliation lease (MP-14, part) | Lease reclaimed after expiry; completing with an expired lease raised `billing_reconciliation_lease_not_owned`; inside one transaction a second claim received 0 rows while the first lease was live. The row was restored with `deferred`, keeping `failure_count` and `last_error_code`.                                                                                                | Database semantics only. No killed Node process, more than 20 candidates or intermediate invoice cursor.            |
| Failing scan diagnosis             | Replaying discovery with the fixed provider returned one `invoice_paid` event whose `accountId` was the checkout id, explaining `reducer_failed`. Replaying `apply_invoice_paid` for that invoice in a rolled-back transaction confirmed it: with the checkout id as account it raised `billing_subscription_not_found`; with the real account it answered `duplicate` (already applied). | The replay used the seller token read-only; the fix is #208.                                                        |
