...
| Mercado Pago v1 Chile acceptance | Monthly CLP, hosted pending/no associated plan | [MP-01–15 matrix](../exec-plans/active/011-mercadopago-v1-chile-acceptance.md): MP-01/02/05/06 (rejection+alert)/07 (both directions)/11/15 closed with real correlated evidence, including a genuine recovery gap repair and a real triple webhook delivery handled without duplication. Renewal is being observed on a live subscription due 2026-10-22; recovery-after-rejection, abandoned/unknown checkout and refunds remain open — an attempted refund did not surface the transaction in the test seller's dashboard, and a rejected checkout got stuck resuming a provider-invalidated preapproval (matches the documented MP-08 manual-resolution behavior). | 2026-09-22           | Scenario + change-bound          | Partially closed; **[NO VERIFICADO]** for the remaining scenarios                                                      |
