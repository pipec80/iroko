...
| Mercado Pago v1 Chile acceptance | Monthly CLP, hosted pending/no associated plan | [MP-01–15 matrix](../exec-plans/active/011-mercadopago-v1-chile-acceptance.md): MP-01/02/05/07/11/15 closed with real correlated evidence, including a genuine recovery gap repair observed live (not induced). Renewal is being observed on a live second subscription due 2026-10-22; rejection/recovery, abandoned/unknown checkout and refunds remain open — an attempted refund did not surface the transaction in the test seller's dashboard, inconclusive so far. | 2026-09-22           | Scenario + change-bound          | Partially closed; **[NO VERIFICADO]** for the remaining scenarios                                                      |
