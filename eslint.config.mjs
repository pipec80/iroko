...
const eslintConfig = defineConfig([
  ...
  globalIgnores([
    ...
    'cypress/**',
    'jest/**',
    // Local Supabase runtime artifacts (gitignored, regenerated by `supabase start`).
    'supabase/.temp/**',
    // Playwright output (gitignored, regenerated by `pnpm test:e2e`) — flat
    // config doesn't read .gitignore, so without this ESLint lints minified
    // vendor JS bundled into the HTML report (thousands of false positives).
    'playwright-report/**',
    'test-results/**',
  ]),
]);
